                        ...
                        <td valign="top">
                            <table width="100%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <%:Html.TextBoxFor(x => x.SM_HintQuestion, new { @readonly = "readonly" })%>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right">
                                    ...
                                    <td>
                                        <%:Html.TextBoxFor(x => x.SM_Hint, new { @readonly = "readonly" })%>
                                    </td>
                                </tr>
                            </table>
                        </td>
            ...
            <td style="width: 40%" valign="top">
                <table width="100%">
                    <tr>
                        ...
                        <td>
                            <%:Html.TextBoxFor(x => x.SM_FirstName, new { @readonly = "readonly" })%>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
                        ...
                        <td>
                            <%:Html.TextBoxFor(x => x.SM_MiddleName, new { @readonly = "readonly" })%>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
                        ...
                        <td>
                            <%:Html.TextBoxFor(x => x.SM_LastName, new { @readonly = "readonly" })%>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
                        ...
                        <td>
                            <%:Html.TextBoxFor(x => x.SM_Mobile, new { @readonly = "readonly" })%>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
                        ...
                        <td>
                            <%:Html.TextBoxFor(x => x.SM_HomePhone, new { @readonly = "readonly" })%>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
                        ...
                        <td>
                            <%:Html.TextBoxFor(x => x.SM_WorkPhone, new { @readonly = "readonly" })%>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
                        ...
                        <td>
                            <%:Html.TextBoxFor(x => x.SM_Address1, new { @readonly = "readonly" })%>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
                        ...
                        <td>
                            <%:Html.TextBoxFor(x => x.SM_Address2, new { @readonly = "readonly" })%>
                        </td>
                    </tr>
                </table>
            </td>
