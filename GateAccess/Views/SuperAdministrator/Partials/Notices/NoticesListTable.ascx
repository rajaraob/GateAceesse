...
<div class="divTable-body">
    ...
    <div id="notice<%=Item.NoticeID%>" class="divTable-row">
        <div style="width: 75%" align="left" class="divTable-labelCell">
            &nbsp;&nbsp;<a class="noticeDetails" name="<%= Item.NoticeID%>" style="color: Blue;
                cursor: pointer"><%= Item.NoticeText%></a>
        </div>
...
<%}%><div id="Div_NoticeDetails">
</div>
<%
  }
  else
  { %><br />
<span style="color: #FF0000">No Notice(s) were Registered..</span>
<%}
%>