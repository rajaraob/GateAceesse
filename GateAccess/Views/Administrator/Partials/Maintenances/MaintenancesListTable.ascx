...
<div class="divTable-body">
    ...
    <div id="maintenance<%=Item.MaintenanceID%>" class="divTable-row">
        ...
        <div class="divTable-labelCell" align="center" style="width: 5%">
            <img name="<%=Item.MaintenanceID%>" class="editMaintenance" 
                src="<%: Url.Content("~/Images/edit.png")%>" style="cursor: pointer" alt="Edit"
                onmousedown="editclick(this)" onmouseup="unclickedit(this)" />
        </div>
        <div class="divTable-labelCell" align="center" style="width: 5%">
...
<% }
  ...
  {%><br />
<span style="color: #FF0000">No Maintenances for this Community were Registered..</span>
<%} %>
