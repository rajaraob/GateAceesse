            ...
            <table width="100%">
                <tr>                    
                    <td style="text-align: right">
                        <img src="<%: Url.Content("~/Images/newlostfound.png")%>" style="cursor: pointer" id="NewLostFound" class="newLostFound" alt="New LostFound" onmousedown="this.src='<%: Url.Content("~/Images/newlostfoundclick.png")%>'"
                            onmouseup="this.src='<%: Url.Content("~/Images/newlostfound.png")%>'" />
                    </td>
                </tr>
            </table>
            <div id="Div_LostFoundsList">
            <% Html.RenderPartial("Partials/LostFounds/LostFoundsList"); %>
            </div>
        </fieldset></div>
</asp:Content>
